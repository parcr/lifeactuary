...
In this version, you've a lot of [tests](https://github.com/parcr/LifeActuary_1.3.2/tree/main/tests), examples;
[essay](https://github.com/parcr/LifeActuary_1.3.2/tree/main/essay),
[essay_for_Manual](https://github.com/parcr/LifeActuary_1.3.2/tree/main/essay_for_Manual) on how to use the library,
as well as our already famous [Manual](https://github.com/parcr/lifeActuary_1.3.2/blob/main/info/lifeActuary_v1_3_2.pdf).

Please don't forget to download the soa_tables folder from GitHub;
[soa_tables](https://github.com/parcr/lifeActuary_1.3.2)
