...
a=mi.t_nAx_mom(mt=ct, x=45, n=10, defer=20, i=4, g=0, method='udd', mom=1)
a2=mi.t_nAx_mom(mt=ct, x=45, n=10, defer=20, i=4, g=0, method='udd', mom=2)
var_a=a2-a**2
print(a, ', ', a2, ', ', var_a)

# Expected Value for t_naax_mom
a=mi.t_naax_mom(mt=ct, x=45, n=10, defer=20, i=4, g=0, method='udd', mom=0)
print(a)

a=mi.t_naax_mom(mt=ct, x=45, n=10, defer=20, i=4, g=0, method='udd', mom=1)
a2=mi.t_naax_mom(mt=ct, x=45, n=10, defer=20, i=4, g=0, method='udd', mom=2)
var_a=a2-a**2
print(a, ', ', a2, ', ', var_a)